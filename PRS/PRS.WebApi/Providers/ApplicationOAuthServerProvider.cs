...
namespace PRS.WebApi.Providers
{
    public class ApplicationOAuthServerProvider : OAuthAuthorizationServerProvider
    {
        ...
        //        if (account == null
        //            || !PasswordHelper.VerifyPassword(account.Password, context.Password)
        //            || !account.IsActive)
        //        {
        //            context.Response.Headers.Add("BadRequestHeader",
        //                new[] { ("Incorrect username or password.").ToString() });
        ...
        //private Dictionary<string, string> GenerateAuthentiocationProperties(AccountModel account)
        //{
